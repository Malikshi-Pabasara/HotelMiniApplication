...
namespace Cenium.Rooms.Activities
{
    ...
    public class RoomTypesActivity : IDisposable
    {
        ...
        [ActivityResult("RoomTypeFeatures")]
        [ActivityResult("RoomTypeFeatures.Feature")]
        ...
        public IEnumerable<RoomType> Query()
        {
            ...
            var result = _ctx.RoomTypes.ReadOnlyQuery().OrderByDescending(p => p.RoomTypeId);
        ...
        public Cenium.Rooms.Data.RoomType Create(RoomType roomType)
        {
            ...
            _ctx.RoomTypes.AttachChildCollection<RoomTypeFeature>(roomType, "RoomTypeFeatures");
            roomType = _ctx.RoomTypes.Add(roomType);
            _ctx.RoomTypes.SynchronizeChildCollection<RoomTypeFeature>(roomType, "RoomTypeFeatures");
            _ctx.SaveChanges();
